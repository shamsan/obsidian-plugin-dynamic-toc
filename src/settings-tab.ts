...
export class DynamicTOCSettingsTab extends PluginSettingTab {
    ...
    display(): void {
        ...
        containerEl.createEl("h2", {
            text: "Dynamic Table of Contents Settings",
        })
        ...
        new Setting(containerEl)
            ...
            .addToggle((cb) =>
                cb
                    .setValue(this.plugin.settings.varied_style)
                    .onChange(async (val) => {
                ...
                cb
                    .addOptions(
                        Object.keys(EXTERNAL_MARKDOWN_PREVIEW_STYLE).reduce(
                            (
                                acc,
                                curr: keyof typeof EXTERNAL_MARKDOWN_PREVIEW_STYLE
                            ) => {
                                const value =
                                    EXTERNAL_MARKDOWN_PREVIEW_STYLE[curr]
